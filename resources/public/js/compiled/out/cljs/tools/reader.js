...
var G__26737 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26737;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26738 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26738,ch);
...
if(("\\" === ch__$1)){
var ch_26739__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26739__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26739__$2);
} else {
}

var G__26740 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26740;
continue;
}
}
...
var vec__26748 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var G__26751 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26751;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26752 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26753 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26753;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26752;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26754 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26754,(0),null);
var start_column = cljs.core.nth.call(null,vec__26754,(1),null);
...
var vec__26757 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26757,(0),null);
var end_column = cljs.core.nth.call(null,vec__26757,(1),null);
...
var vec__26760 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26760,(0),null);
var start_column = cljs.core.nth.call(null,vec__26760,(1),null);
...
var vec__26763 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26763,(0),null);
var end_column = cljs.core.nth.call(null,vec__26763,(1),null);
...
var vec__26766 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26766,(0),null);
var start_column = cljs.core.nth.call(null,vec__26766,(1),null);
...
var vec__26769 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26769,(0),null);
var end_column = cljs.core.nth.call(null,vec__26769,(1),null);
...
var sb = (function (){var G__26772 = (new goog.string.StringBuffer());
G__26772.append(initch);
...
var G__26774 = (function (){var G__26773 = sb;
G__26773.append(ch);
...
switch (G__26778) {
case "\\":
var G__26782 = (function (){var G__26779 = sb;
G__26779.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26779;
})();
var G__26783 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26782;
ch = G__26783;
continue;
...
break;
default:
var G__26784 = (function (){var G__26780 = sb;
G__26780.append(ch);

return G__26780;
})();
var G__26785 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26784;
ch = G__26785;
continue;
...
var vec__26786 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26786,(0),null);
var end_column = cljs.core.nth.call(null,vec__26786,(1),null);
...
var vec__26789 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26789,(0),null);
var column = cljs.core.nth.call(null,vec__26789,(1),null);
...
var line = cljs.core.nth.call(null,vec__26794,(0),null);
var column = cljs.core.nth.call(null,vec__26794,(1),null);
...
var vec__26799 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26799,(0),null);
var column = cljs.core.nth.call(null,vec__26799,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26804 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26804,(0),null);
var start_column = cljs.core.nth.call(null,vec__26804,(1),null);
...
var vec__26807 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26807,(0),null);
var end_column = cljs.core.nth.call(null,vec__26807,(1),null);
...
var G__26810 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26810,true,null,opts,pending_forms);
...
var G__26811 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26811)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26811)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26811)){
...
var _STAR_suppress_read_STAR__orig_val__26812 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26813 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26813;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26812;
}});
...
var G__26814 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26814,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26814,rdr,first_line);
...
var G__26818 = matched;
var G__26819 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26818;
finished = G__26819;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__26820 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26821 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26821;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26820;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__26822 = cljs.tools.reader.arg_env;
var arg_env_temp_val__26823 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__26823;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26824 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26824,"(");
...
var G__26825 = (i + (1));
var G__26826 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__26822;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26827 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26827);
...
var G__26828 = cljs.core.next.call(null,s__$1);
var G__26829 = ret;
s__$1 = G__26828;
r = G__26829;
continue;
...
var G__26830 = cljs.core.next.call(null,s);
var G__26831 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26830;
key_vals = G__26831;
continue;
} else {
...
var gensym_env_orig_val__26835 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26836 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__26836;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__26835;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26837 = token;
var G__26837__$1 = (((G__26837 == null))?null:cljs.core.subs.call(null,G__26837,(1)));
var G__26837__$2 = (((G__26837__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26837__$1));
var G__26837__$3 = (((G__26837__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26837__$2));
var G__26837__$4 = (((G__26837__$3 == null))?null:cljs.core.symbol.call(null,G__26837__$3));
if((G__26837__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26837__$4);
}
})():(function (){var G__26838 = token;
var G__26838__$1 = (((G__26838 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26838));
if((G__26838__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26838__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26849,reader){
...
var opts = map__26850__$1;
var eof = cljs.core.get.call(null,map__26850__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26856){
var G__26857 = cljs.core.first.call(null,seq26856);
var seq26856__$1 = cljs.core.next.call(null,seq26856);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26857,seq26856__$1);
});


//# sourceMappingURL=reader.js.map?rel=1563741475114
