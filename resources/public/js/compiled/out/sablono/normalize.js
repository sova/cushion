...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__20981){
var vec__20982 = p__20981;
var _ = cljs.core.nth.call(null,vec__20982,(0),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__20985_SHARP_){
return (((p1__20985_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__20985_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__20986,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__20986;
}
});
...
var G__20988 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_.call(null,classes)))){
return cljs.core.assoc.call(null,G__20988,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__20988;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq20987){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20987));
});
...
var vec__20994 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__20994,(0),null);
var names = cljs.core.nth.call(null,vec__20994,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__20994,tag_name,names){
return (function (p1__20992_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__20992_SHARP_))){
return p1__20992_SHARP_;
} else {
return null;
}
});})(matches,vec__20994,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__20994,tag_name,names){
return (function (p1__20993_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__20993_SHARP_));
});})(matches,vec__20994,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__20997){
...
var tag = first__21000;
var content = seq__20999__$1;
...
var vec__21001 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__21001,(0),null);
var id = cljs.core.nth.call(null,vec__21001,(1),null);
var class$ = cljs.core.nth.call(null,vec__21001,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1563741464687
