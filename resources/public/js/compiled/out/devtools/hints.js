...
var file = cljs.core.get.call(null,map__24447__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__24447__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__24447__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e24446){var _e = e24446;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___24449 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___24449)){
var seen_errors_24450 = temp__5718__auto___24449;
if(cljs.core.truth_(seen_errors_24450.has(self))){
} else {
seen_errors_24450.add(self);

var temp__5720__auto___24451 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___24451)){
var sense_24452 = temp__5720__auto___24451;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24452)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1563741468955
