...
var G__24674 = devtools.prefs.pref.call(null,v);
v = G__24674;
continue;
} else {
return v;
...
}catch (e24677){var _e__24417__auto__ = e24677;
return false;
}})();
...
}catch (e24681){var _e__24417__auto__ = e24681;
return false;
}})();
...
}catch (e24683){var _e__24417__auto__ = e24683;
return false;
}}
}
});
...
var vec__24685 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24685,(0),null);
var name = cljs.core.nth.call(null,vec__24685,(1),null);
...
return cljs.core.some.call(null,(function (p1__24688_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24688_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1563741469652
