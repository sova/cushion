...
var o24569 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24569["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24570 = temp__5718__auto____$1;
return (o24570["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24410__auto__ = f;
return (o__24410__auto__["toString"]).call(o__24410__auto__);
} else {
return "";
}
}catch (e24571){var _ = e24571;
return "";
}});
...
try{var o__24410__auto___24573 = t;
(o__24410__auto___24573["cljs$lang$ctorPrWriter"]).call(o__24410__auto___24573,t,writer);
}catch (e24572){var __24574 = e24572;
}
...
var char_code = (function (){var o__24410__auto__ = (new String(char$));
return (o__24410__auto__["charCodeAt"]).call(o__24410__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24410__auto__ = String;
return (o__24410__auto__["fromCharCode"]).call(o__24410__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24575 = num_code;
switch (G__24575) {
case (1):
return (185);
...
var o__24410__auto__ = String;
return (o__24410__auto__["fromCharCode"]).call(o__24410__auto__,superscript_code);
});
/**
...
}catch (e24577){var _e__24417__auto__ = e24577;
return false;
}})())){
...
var vec__24578 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24578,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o24581 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24581["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24582 = temp__5718__auto____$1;
return (o24582["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___24589 = arguments.length;
var i__4731__auto___24590 = (0);
while(true){
if((i__4731__auto___24590 < len__4730__auto___24589)){
args__4736__auto__.push((arguments[i__4731__auto___24590]));

var G__24591 = (i__4731__auto___24590 + (1));
i__4731__auto___24590 = G__24591;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24585){
var vec__24586 = p__24585;
var ns_detector = cljs.core.nth.call(null,vec__24586,(0),null);
...
var G__24592 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24593 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24592;
remaining_tokens = G__24593;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24583){
var G__24584 = cljs.core.first.call(null,seq24583);
var seq24583__$1 = cljs.core.next.call(null,seq24583);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24584,seq24583__$1);
});
...
var vec__24597 = cljs.core.split_with.call(null,(function (p1__24596_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24596_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24597,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24597,(1),null);
...
var vec__24603 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24603,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24603,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24606 = cljs.core.rest.call(null,remaining_tokens);
var G__24607 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24606;
name_tokens = G__24607;
continue;
} else {
...
var vec__24610 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24610,(0),null);
var arity = cljs.core.nth.call(null,vec__24610,(1),null);
var vec__24613 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24613,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24613,(1),null);
var vec__24616 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24616,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24616,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24616,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24616,(3),null);
...
var vec__24622 = result;
var munged_ns = cljs.core.nth.call(null,vec__24622,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24622,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24622,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24622,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24622,(4),null);
var arity = cljs.core.nth.call(null,vec__24622,(5),null);
...
var munged_name = cljs.core.nth.call(null,vec__24626,(0),null);
var args = cljs.core.nth.call(null,vec__24626,(1),null);
var vec__24629 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24629,(0),null);
var name = cljs.core.nth.call(null,vec__24629,(1),null);
...
var G__24632 = (arity + (1));
var G__24633 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24634){
var vec__24635 = p__24634;
var arity = cljs.core.nth.call(null,vec__24635,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24635,(1),null);
...
return cljs.core.get.call(null,arities,p1__24638_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24639_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24642){
var vec__24643 = p__24642;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24643,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24640){
var G__24641 = cljs.core.first.call(null,seq24640);
var seq24640__$1 = cljs.core.next.call(null,seq24640);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24641,seq24640__$1);
});
...
var map__24651 = options;
var map__24651__$1 = (((((!((map__24651 == null))))?(((((map__24651.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24651.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24651):map__24651);
var include_ns_QMARK_ = cljs.core.get.call(null,map__24651__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24651__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24651__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24651__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24652 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24652,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24652,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24652,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24652,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24652,(4),null);
var arity = cljs.core.nth.call(null,vec__24652,(5),null);
...
var o__24410__auto__ = f;
return (o__24410__auto__["getBasis"]).call(o__24410__auto__);
});
/**
...
}catch (e24656){var _e__24417__auto__ = e24656;
...
var G__24657 = (obj[cljs.core.first.call(null,path)]);
var G__24658 = cljs.core.rest.call(null,path);
obj = G__24657;
path = G__24658;
continue;
} else {
...
return (function (accum,p__24659){
var vec__24660 = p__24659;
var bit = cljs.core.nth.call(null,vec__24660,(0),null);
var protocol = cljs.core.nth.call(null,vec__24660,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24663){
var vec__24664 = p__24663;
var ns = cljs.core.nth.call(null,vec__24664,(0),null);
var name = cljs.core.nth.call(null,vec__24664,(1),null);
var selector = cljs.core.nth.call(null,vec__24664,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24669,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24669,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24669,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24667_SHARP_){
return (obj[cljs.core.first.call(null,p1__24667_SHARP_)]);
});})(name,sorted_matches,vec__24669,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1563741469488
