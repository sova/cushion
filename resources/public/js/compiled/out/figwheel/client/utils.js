...
return (new CustomEvent(event_name,(function (){var obj30373 = ({"detail":data});
return obj30373;
})()));
} else {
...
var f = (function (){var pred__30380 = cljs.core._EQ_;
var expr__30381 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30380.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30381))){
return ((function (pred__30380,expr__30381){
return (function (p1__30374_SHARP_){
return console.warn(p1__30374_SHARP_);
});
;})(pred__30380,expr__30381))
} else {
if(cljs.core.truth_(pred__30380.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30381))){
return ((function (pred__30380,expr__30381){
return (function (p1__30375_SHARP_){
return console.debug(p1__30375_SHARP_);
});
;})(pred__30380,expr__30381))
} else {
if(cljs.core.truth_(pred__30380.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30381))){
return ((function (pred__30380,expr__30381){
return (function (p1__30376_SHARP_){
return console.error(p1__30376_SHARP_);
});
;})(pred__30380,expr__30381))
} else {
return ((function (pred__30380,expr__30381){
return (function (p1__30377_SHARP_){
return console.log(p1__30377_SHARP_);
});
;})(pred__30380,expr__30381))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30384){
var map__30385 = p__30384;
var map__30385__$1 = (((((!((map__30385 == null))))?(((((map__30385.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30385.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__30385):map__30385);
var opts = map__30385__$1;
var eval_fn = cljs.core.get.call(null,map__30385__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30387_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__30389,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1563741479514
